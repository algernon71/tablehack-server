...
@Slf4j
public class SceneDataConverter implements AttributeConverter<SceneData, String> {

  private final static ObjectMapper objectMapper = new ObjectMapper();

  @Override
  public String convertToDatabaseColumn(SceneData meta) {
      if (meta == null) {
          return null;
      }
    try {
  ...
  @Override
  public SceneData convertToEntityAttribute(String dbData) {
      if (dbData == null) {
          return null;
      }
    try {
      return objectMapper.readValue(dbData, SceneData.class);
