...
@Slf4j
public class CardTypeFieldListConverter implements AttributeConverter<CardTypeFieldList, String> {

  private final static ObjectMapper objectMapper = new ObjectMapper();

  @Override
  public String convertToDatabaseColumn(CardTypeFieldList meta) {
      if (meta == null) {
          return null;
      }
    try {
  ...
  @Override
  public CardTypeFieldList convertToEntityAttribute(String dbData) {
      if (dbData == null) {
          return null;
      }
    try {
      return objectMapper.readValue(dbData, CardTypeFieldList.class);
